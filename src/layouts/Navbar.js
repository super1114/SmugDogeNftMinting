        ...
        <div className='mx-auto items-center bg-metal border-b-2 border-midnight py-3 pl-3'>
          <div className='flex'>
            ...
            <div className='hidden lg:block flex items-center mt-5'>
              ...
              <a href='#' className='ml-3 rounded-md font-semibold bg-midnight py-2 px-7 hover:border-gray hover:bg-orange hover:text-gray'>
                TRAIT GALLARY
              </a>
            ...
            sideBarOpen ? (
              <div className="lg:hidden md:flex sm:flex xs:flex flex-col justify-between flex-1 items-center border-l-4 border-yellow pl-3" id="mobile_menu">
                ...
                <div className="flex items-center justify-start">
                  ...
                  <a className="text-white pr-4">TRAIT GALLARY</a>
                ...
                <div className='flex'>
                  <div>
                    ...
                    <div className="flex items-center justify-start">
                      ...
                      <a className="text-white pr-4">Telegram</a>
                  ...
                  <div className='ml-3'>
                    ...
                    <div className="flex items-center justify-start">
                      <a className="text-white pr-4">Contact</a>
                    </div>
                  </div>
                </div>
